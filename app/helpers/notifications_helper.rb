module NotificationsHelper
  ...
  def notification_form(notification)
    ...
    when 'like'
      tag.a(notification.visitor.name, href: user_path(@visitor), style: "font-weight: bold;") + 'が' + tag.a('あなたの投稿', href: post_path(notification.post_id), style: "font-weight: bold;") + 'に「いいね！」しました。'
    when 'comment' then
      #コメントの内容と投稿のタイトルを取得　      
